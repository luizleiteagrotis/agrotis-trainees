...
public class ParceiroNegocioCont {

    private final ParceiroNegocioService negocioService;

    public ParceiroNegocioCont(ParceiroNegocioService negocioService) {
    ...
    public ResponseEntity<?> update(@PathVariable Integer id, @RequestBody ParceiroNegocioDto dto) {
        return ResponseEntity.ok(negocioService.update(id, dto));
    }
