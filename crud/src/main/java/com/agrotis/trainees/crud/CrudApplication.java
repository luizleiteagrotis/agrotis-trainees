...
public class CrudApplication implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        //
        // ParceiroNegocio porId1 =
        // parceiroNegocioService.buscarPorId(parceiroNegocio2.getId());
        // LOG.info("Busca por id. Nome {} id {} ", porId1.getNome(),
        // porId1.getId());
        //
        // List<ParceiroNegocio> todosSalvos2 =
        // parceiroNegocioService.listarTodos();
        // LOG.info("Salvos no total de {} TIPOS de Parceiros de Negocios",
        // todosSalvos2.size());
        //
        // ParceiroNegocio porNome2 =
        ...
        // LOG.info("Busca por Nome. Nome {} id {} ", porNome2.getNome(),
        // porNome2.getId());
        //
        // parceiroNegocioService.buscarPorId(parceiroNegocio2.getId());
        ...
        // produto.setDataFabricacao(LocalDate.parse("09/05/2023",
        // DateTimeFormatter.ofPattern("dd/MM/yyyy")));
        // produto.setDataValidade(LocalDate.parse("09/05/2023",
        // DateTimeFormatter.ofPattern("dd/MM/yyyy")));
        ...
        // novoProduto.setDataFabricacao(LocalDate.parse("09/05/2023",
        // DateTimeFormatter.ofPattern("dd/MM/yyyy")));
        // novoProduto.setDataValidade(LocalDate.parse("09/05/2023",
        // DateTimeFormatter.ofPattern("dd/MM/yyyy")));
        // novoProduto.setEstoque(15);
        ...
        //
        // notaFiscal.setData(LocalDate.parse("09/05/2023",
        // DateTimeFormatter.ofPattern("dd/MM/yyyy")));
        // notaFiscal.setTipo(NotaFiscalTipo.ENTRADA);
        // notaFiscal.setNumero(210798);
        // notaFiscal.setParceiroNegocio(parceiroNegocioService.buscarPorId(614));
        // notaFiscal.setValorTotal(12.0);
        // notaFiscalService.salvar(notaFiscal);
        // LOG.info("Nota Fiscal Salva: {}", notaFiscal.getId());
        //
        // NotaFiscal notaFiscalSaida = new NotaFiscal();
        // notaFiscalSaida.setData(LocalDate.parse("09/05/2023",
        // DateTimeFormatter.ofPattern("dd/MM/yyyy")));
        // notaFiscalSaida.setTipo(NotaFiscalTipo.SAIDA);
        // notaFiscalSaida.setNumero(6193007);
        // notaFiscalSaida.setValorTotal(18.0);
        // notaFiscalSaida.setParceiroNegocio(parceiroNegocioService.buscarPorId(614));
        ...
        // LOG.info("Em processo de busca da nota por ID {}",
        // notaFiscal.getId());
        //
        // notaFiscalService.update(notaFiscalSaida.getId(), notaFiscalSaida);
        // LOG.info("Atualizando a Nota Fiscal pelo ID {}",
        // notaFiscalSaida.getId());
        //
        ...
        itemNota.setNotaFiscal(notaFiscalService.buscarPorId(589));
        itemNota.setProduto(produtoService.buscarPorId(8));
        itemNota.setPrecoUnitario(19.90);
        itemNota.setQuantidade(5);
        itemNota.setValorTotal(10.0);
        ...
        ItemNotaFiscal itemUpdate = itemNotaFiscalService.buscarPorId(98);

        itemUpdate.setNotaFiscal(notaFiscalService.buscarPorId(589));
        itemUpdate.setProduto(produtoService.buscarPorId(2));
        itemUpdate.setPrecoUnitario(19.90);
        itemUpdate.setQuantidade(700);
        itemUpdate.setValorTotal(12.0);

        itemNotaFiscalService.update(itemUpdate);
    }
