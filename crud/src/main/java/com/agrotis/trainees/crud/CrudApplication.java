...
// NotaFiscalService notaFiscalService, ItemNotaFiscalService
// itemNotaFiscalService) {
...
// produtoAtualizado.setDataFabricacao(LocalDate.parse("14/07/2022",
// DateTimeFormatter.ofPattern("dd/MM/yyyy")));
// produtoAtualizado.setDataValidade(LocalDate.parse("11/07/2024",
// DateTimeFormatter.ofPattern("dd/MM/yyyy")));
...
// notaFiscal.setDataNf(LocalDate.parse("09/10/1999",
// DateTimeFormatter.ofPattern("dd/MM/yyyy")));
...
// notaFiscalAtualiza.setDataNf(LocalDate.parse("30/05/2024",
// DateTimeFormatter.ofPattern("dd/MM/yyyy")));
