...
public class CrudApplication implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        parceiroNegocio3.setNome("Service5");
        parceiroNegocio3.setInscricaoFiscal("1066997339847993");
        parceiroNegocio3.setEndereco("Avenida Sete de Setembro, 68");
        parceiroNegocio3.setTelefone("4133648224");
        ...
        produtoAtualizado.setDescricao("Arroz");
        ...
        produtoAtualizado2.setDataFabricacao(LocalDate.parse("20/12/2020", DateTimeFormatter.ofPattern("dd/MM/yyyy")));
        produtoAtualizado2.setDataValidade(LocalDate.parse("30/03/2023", DateTimeFormatter.ofPattern("dd/MM/yyyy")));
        ...
        notaFiscal.setData(LocalDateTime.of(2023, Month.JANUARY, 03, 0, 0));
